#!/usr/bin/env python3
"""Merge contacts from cornell_med.db (GitHub) into prospect_engine's cornell_to_med_school.db.

Designed to run on EC2 via cron after git-pulling the latest cornell_med.db.
...
# Paths on EC2
GITHUB_DB = Path(__file__).parent / "cornell_med.db"
PROSPECT_DB = Path("/home/ubuntu/apps/prospect_engine/backend/profiles/cornell_to_med_school.db")
