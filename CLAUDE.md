# Cornell Med School Finder

Finds Cornell University undergrad alumni who went to top-20 US medical schools.
...
names = get_existing_names('cornell_med.db')
print(f'Existing contacts: {len(names)}')
for n in names: print(f'  - {n}')
print()
verticals = pick_verticals_for_run('cornell_med.db', count=3)
...
- Google: "Cornell" + "[med school name]" + "class of 2025" or "class of 2026" or "class of 2027" or "class of 2028"
- Medical school class profile pages and student directories
- Cornell pre-med advising spotlights and Cornell alumni magazine features on recent grads
...
- Cornell Daily Sun (student newspaper) articles about students accepted to med school
...
[
  {
    ...
    "prospect_notes": "4-6 sentences about their background, Cornell undergrad details, med school details, research interests.",
    "_enrichment": {
      "found": true,
      "first_name": "First",
      "last_name": "Last",
...
- `cornell_med.db` — SQLite with `companies` and `contacts` tables
