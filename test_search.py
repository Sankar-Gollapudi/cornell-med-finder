"""Tests for the Cornell med school finder."""
import json
import os
import sqlite3
import tempfile
    ...
    return [
        {
            ...
            "prospect_notes": "John Smith graduated from Cornell University in 2021 with a BS in Biology and a minor in Chemistry. He conducted research in Dr. Jane Doe's immunology lab for three years. He is currently a second-year MD/PhD student at Harvard Medical School studying neuroscience.",
        },
        {
            ...
            "prospect_notes": "Jane Doe graduated from Cornell University in 2022 with a BA in Neuroscience and Behavioral Biology. She was president of the Cornell Pre-Med Society and volunteered at Cayuga Medical Center. She is now a first-year MD student at Stanford School of Medicine.",
        },
    ]
